            ...
            <?php foreach ($order_ids ?? [] as $order_id) {
                ...
                <div class="single-order <?= $order_color_theme ?>">
                    ...
                    <div class="row order-date">
                        <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/date-' . $order_color_theme . '.svg' ?>">
                        <p><?= $order_date ?></p>
                    </div>
                    <div class="row order-user-name">
                        <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/customer-' . $order_color_theme . '.svg' ?>">
                        <p><?= $order_user ?> <br/>Benutzerrolle: <?= ucfirst($order_user_role) ?></p>
                    </div>
                    <div class="row order-user-stands">
                        <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/stand-cat-' . $order_color_theme . '.svg' ?>">
                        <p><?= $order_meta;
                            $order_meta = null; ?></p>
                    </div>
                    <div class="row order-stand-id">
                        <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/stand-number-' . $order_color_theme . '.svg' ?>">
                        <p>Rechnungsbetrag: <?= $order_price ?>€</p>
                    </div>
                    <div class="row order-invoice-number">
                        <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/order-' . $order_color_theme . '.svg' ?>">
                        <p>Rechnungsnummer: <?= $order_invoice_number ?></p>
                    </div>
                    <div class="row invoice-pdf">
                        <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/download-pdf-' . $order_color_theme . '.svg' ?>">
                    ...
                    <div class="hidden-order-information">
                        ...
                        <div class="payment-status">
                            <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/check-' . $order_color_theme . '.svg' ?>">
                            <p>Bezahlstatus: <?= $order_status_description ?></p>
                        </div>
                        <div class="phone">
                            <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/phone-' . $order_color_theme . '.svg' ?>">
                            <a href="tel:<?= $order_user_phone ?>"><?= $order_user_phone ?></a>
                        </div>
                        <div class="email">
                            <img src="<?= BOOKINGPORT_PLUGIN_URI . '/assets/images/icons/orders/mail-' . $order_color_theme . '.svg' ?>">
